...
const HistoryHome = ({domain}) => {
  ...
  return (
    <>
      {list && list.length > 0 && <Boundary labels={config?.configSetting?.lbl_bookmark} linkNext={`/bookmark`} lableLink={config?.configSetting?.lbl_view_more}/>}
