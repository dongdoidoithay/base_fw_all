...
const PopupHome = ({ typeManga,nameLable ,data_popular,domain}) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap  pt-1">
        {(!data_popular || (data_popular&& data_popular.length <=0)) && popularSkeleton()}
        {data_popular && data_popular.length >0 && data_popular.map((data: any, index: number) =>
