...
export const _Brand_Name="ReaperBr";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">REAPER 🐇</span><span class="text-orange-600 font-bold">Br</span>`;
export const _lbl_domain_Page="reaperbr.org";
export const _lbl_domain_name="reaperbr.org";
export const _sb_seo_default_image="https://reaperbr.org/bg_br.jpg";
...
export const analytics_key='G-GHJ9KJJ4S8';
