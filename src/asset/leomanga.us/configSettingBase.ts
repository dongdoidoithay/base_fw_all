...
export const _Brand_Name="LeoManga";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Leo 🐠</span><span class="text-orange-600 font-bold"> Manga</span>`;
export const _lbl_domain_Page="leomanga.us";
export const _lbl_domain_name="leomanga.us";
export const _sb_seo_default_image="https://leomanga.us/bg.jpg";
...
export const analytics_key='G-TWZ1Z97Q7Y';
