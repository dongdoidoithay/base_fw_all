...
export const _Brand_Name="Overgeared";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Overgeared 🐇</span><span class="text-orange-600 font-bold"></span>`;
export const _lbl_domain_Page="overgeared.org";
export const _lbl_domain_name="overgeared.org";
export const _sb_seo_default_image="https://overgeared.org/bg_br.jpg";
...
export const analytics_key='G-5Q9DFREP0K';
