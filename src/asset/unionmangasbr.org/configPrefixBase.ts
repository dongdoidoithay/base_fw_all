...
export const _host="https://www.unionmangasbr.org";
export const _hostwww="https://www.unionmangasbr.org";


export const _Prefix_Root_Manga_Br='manga-br';
export const _Prefix_Root_Adult_Br='adult-br';
export const _Prefix_Root_Scan='scan';
export const _Prefix_Root_Raw='raw';
export const _Prefix_Root_Adult='manhwa';
export const _Prefix_Root_Dc='comic-dc';
export const _Prefix_Root_Novel='novels';
...
export const _Prefix_Root_Italy='italy';
export const _Prefix_Type_Italy='italy';

export const _Prefix_Root_Indo='indo';
export const _Prefix_Type_Indo='indo';
...
export const MangaItalyPrefix:ConfigPrefix={
    pageManga:`/${_Prefix_Root_Italy}`,
    pageGenre:`/${_Prefix_Root_Italy}/genre`,
    pageYear:`/${_Prefix_Root_Italy}/year`,
    pageAuth:`/${_Prefix_Root_Italy}/auth`,
    pageType:`/${_Prefix_Root_Italy}/type`,
    pageScan:`/${_Prefix_Root_Italy}/scan`,
    pageArt:`/${_Prefix_Root_Italy}/art`,
    pageStatus:`/${_Prefix_Root_Italy}/status`,
    pageViewManga:`/${_Prefix_Root_Italy}`,
    pageAlphaBet:`/${_Prefix_Root_Italy}/a-z`,
    pageTag:`/${_Prefix_Root_Italy}/tags`,
...
export const MangaIndoPrefix:ConfigPrefix={
    pageManga:`/${_Prefix_Root_Indo}`,
    pageGenre:`/${_Prefix_Root_Indo}/genre`,
    pageYear:`/${_Prefix_Root_Indo}/year`,
    pageAuth:`/${_Prefix_Root_Indo}/auth`,
    pageType:`/${_Prefix_Root_Indo}/type`,
    pageScan:`/${_Prefix_Root_Indo}/scan`,
    pageArt:`/${_Prefix_Root_Indo}/art`,
    pageStatus:`/${_Prefix_Root_Indo}/status`,
    pageViewManga:`/${_Prefix_Root_Indo}`,
    pageAlphaBet:`/${_Prefix_Root_Indo}/a-z`,
    pageTag:`/${_Prefix_Root_Indo}/tags`,
