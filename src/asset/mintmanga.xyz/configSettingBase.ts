...
export const _Brand_Name="MintManga";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">mint 🐠</span><span class="text-orange-600 font-bold"> Manga</span>`;
export const _lbl_domain_Page="mintmanga.xyz";
export const _lbl_domain_name="mintmanga.xyz";
export const _sb_seo_default_image="https://mintmanga.xyz/bg.jpg";
...
export const analytics_key='G-THN12YKHTE';
