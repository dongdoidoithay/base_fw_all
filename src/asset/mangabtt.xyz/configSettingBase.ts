...
export const _Brand_Name="Manga BTT";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold"> 🥇 BTT</span>`;
export const _lbl_domain_Page="mangabtt.xyz";
export const _lbl_domain_name="mangabtt.xyz";
export const _sb_seo_default_image="https://mangabtt.xyz/bg.jpg";
...
export const analytics_key='G-VSJXN1ZNWL';
