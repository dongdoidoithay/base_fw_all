...
export const _lbl_domain_Page="yesmanga.lol";
export const _lbl_domain_name="yesmanga.lol";
export const _sb_seo_default_image="https://yesmanga.lol/bg.jpg";
...
export const analytics_key='G-MKK8RTGH1R';
