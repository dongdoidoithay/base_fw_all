...
export const _Brand_Name="manga-italia";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Italia 🐠</span><span class="text-orange-600 font-bold"> Manga</span>`;
export const _lbl_domain_Page="manga-italia.org";
export const _lbl_domain_name="manga-italia.org";
export const _sb_seo_default_image="https://manga-italia.org/bg.jpg";
...
export const analytics_key='G-6W075L7JJW';
