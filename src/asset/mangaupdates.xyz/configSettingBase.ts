...
export const _lbl_domain_Page="mangaupdates.xyz";
export const _lbl_domain_name="mangaupdates.xyz";
export const _sb_seo_default_image="https://mangaupdates.xyz/bg.jpg";
