...
export const _Brand_Name="1stkissmanga";
export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">1ST</span><span class="text-orange-600 font-bold">💞KISS</span>`;
export const _sb_seo_default_image="https://1stkissmanga.us/bg.jpg";
export const _lbl_domain_Page="1stkissmanga.us";
export const _lbl_domain_name="1stkissmanga.us";
...
export const analytics_key='G-LV99NPQWNC';
