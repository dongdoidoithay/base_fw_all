...
export const _Brand_Name="MangaForever";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Forever 🐠</span><span class="text-orange-600 font-bold"> FUMETTI</span>`;
export const _lbl_domain_Page="mangaforever.xyz";
export const _lbl_domain_name="mangaforever.xyz";
export const _sb_seo_default_image="https://mangaforever.xyz/bg.jpg";
...
export const analytics_key='G-1C25TRG91V';
