...
export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGÁS</span><span class="text-orange-600 font-bold">👻 UNION</span>`;
export const _lbl_domain_Page="unionmanga.xyz";
export const _lbl_domain_name="unionmanga.xyz";
export const _sb_seo_default_image="https://unionmanga.xyz/bg.jpg";
...
export const analytics_key='G-PK526W226M';
