...
export const _Brand_Name="pandamanga";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">✯ PANDA</span>`;
export const _lbl_domain_Page="pandamanga.net";
export const _lbl_domain_name="pandamanga.net";
export const _sb_seo_default_image="https://pandamanga.net/bg.jpg";
...
export const analytics_key='G-FV6F8M3G53';
