...
export const _Brand_Name="Unionleitor";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Union 🐇</span><span class="text-orange-600 font-bold">Leitor</span>`;
export const _lbl_domain_Page="unionleitor.net";
export const _lbl_domain_name="unionleitor.net";
export const _sb_seo_default_image="https://unionleitor.net/bg.jpg";
...
export const analytics_key='G-RC1XC6Z55L';
