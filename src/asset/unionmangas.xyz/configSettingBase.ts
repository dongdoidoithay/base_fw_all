...
export const _Brand_Name="Unionmangas";
...
export const _lbl_domain_Page="unionmangas.xyz";
export const _lbl_domain_name="unionmangas.xyz";
export const _sb_seo_default_image="https://unionmangas.xyz/bg.jpg";
...
export const analytics_key='G-0FKK3DYKVY';
