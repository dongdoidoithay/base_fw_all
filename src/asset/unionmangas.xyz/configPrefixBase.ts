/* const _host="http://localhost:5030";
const _hostwww="http://www.localhost:5030";   */
export const _host="https://www.unionmangas.xyz";
export const _hostwww="https://www.unionmangas.xyz"; 
