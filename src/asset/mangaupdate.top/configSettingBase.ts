...
export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">🥇 UPDATE</span>`;
export const _lbl_domain_Page="mangaupdate.topl";
export const _lbl_domain_name="mangaupdate.topl";
export const _sb_seo_default_image="https://mangaupdate.topl/bg.jpg";
...
export const analytics_key='G-VLE9EFTJMC';
