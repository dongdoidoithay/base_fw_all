...
export const _Brand_Name="LerManga";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">LER 🐇</span><span class="text-orange-600 font-bold">Manga</span>`;
export const _lbl_domain_Page="lermanga.xyz";
export const _lbl_domain_name="lermanga.xyz";
export const _sb_seo_default_image="https://lermanga.xyz/bg_br.jpg";
...
export const analytics_key='G-YNBTH8ZYGD';
