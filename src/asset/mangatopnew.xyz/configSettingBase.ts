...
export const _Brand_Name="mangatopnew";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🪐MANGA</span><span class="text-orange-600 font-bold">TOP NEW</span>`;
export const _lbl_domain_Page="mangatopnew.xyz";
export const _lbl_domain_name="mangatopnew.xyz";
export const _sb_seo_default_image="https://mangatopnew.xyz/bg.jpg";
...
export const analytics_key='G-S010M1VJKW';
