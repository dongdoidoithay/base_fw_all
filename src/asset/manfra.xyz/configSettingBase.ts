...
export const _Brand_Name="manfra";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Manga 🐠</span><span class="text-orange-600 font-bold"> Fra</span>`;
export const _lbl_domain_Page="manfra.xyz";
export const _lbl_domain_name="manfra.xyz";
export const _sb_seo_default_image="https://manfra.xyz/bg.jpg";
...
export const analytics_key='G-VHF62VH5SY';
