...
export const _Brand_Name="mangaborn";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Mangare</span>✧<span class="text-orange-600 font-bold">💫Born</span>`;
export const _lbl_domain_Page="mangareborn.xyz";
export const _lbl_domain_name="mangareborn.xyz";
export const _sb_seo_default_image="https://mangareborn.xyz/image/bg.jpg";
...
export const analytics_key='G-JC4MTH4WSV';
