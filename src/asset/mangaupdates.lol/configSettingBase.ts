...
export const _Brand_Name="mangaUpdates";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🅼🅰🅽🅶🅰</span><span class="text-orange-600 font-bold">💯 Update</span>`;
export const _lbl_domain_Page="mangaupdates.lol";
export const _lbl_domain_name="mangaupdates.lol";
export const _sb_seo_default_image="https://mangaupdates.lol/bg.jpg";
...
export const analytics_key='G-BV5CRM1770';
