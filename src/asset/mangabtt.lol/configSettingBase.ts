...
export const _lbl_domain_Page="mangabtt.lol";
export const _lbl_domain_name="mangabtt.lol";
export const _sb_seo_default_image="https://mangabtt.lol/bg.jpg";
...
export const analytics_key='G-R2MW3YJE8E';
