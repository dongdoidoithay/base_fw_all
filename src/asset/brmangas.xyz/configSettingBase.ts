...
export const _Brand_Name="BR Mangas";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">BR 🐇</span><span class="text-orange-600 font-bold">Manga</span>`;
export const _lbl_domain_Page="brmangas.xyz";
export const _lbl_domain_name="brmangas.xyz";
export const _sb_seo_default_image="https://brmangas.xyz/bg_br.jpg";
...
export const analytics_key='G-K8516EH3ED';
