...
export const _Brand_Name="MangaForest";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Forest 🐠</span><span class="text-orange-600 font-bold"> 𝓜𝓐𝓝𝓖𝓐</span>`;
export const _lbl_domain_Page="mangaforest.xyz";
export const _lbl_domain_name="mangaforest.xyz";
export const _sb_seo_default_image="https://mangaforest.xyz/bg.jpg";
...
export const analytics_key='G-CHEK04XG5N';
