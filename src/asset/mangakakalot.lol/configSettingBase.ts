...
export const _Brand_Name="mangaKakalot";


export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Kakalot</span><span class="text-orange-600 font-bold">🔜 Manga</span>`;
export const _lbl_domain_Page="mangakakalot.lol";
export const _lbl_domain_name="mangakakalot.lol";
export const _sb_seo_default_image="https://mangakakalot.lol/bg.jpg";
...
export const analytics_key='G-6MBP5BYG4V';
