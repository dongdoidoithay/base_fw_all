...
export const _Brand_Name="starmanga";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">STAR 🐇</span><span class="text-orange-600 font-bold">✨ MANGA</span>`;
export const _lbl_domain_Page="starmanga.xyz";
export const _lbl_domain_name="starmanga.xyz";
export const _sb_seo_default_image="https://starmanga.xyz/bg.jpg";
...
export const analytics_key='G-EN9FKHH2BS';
