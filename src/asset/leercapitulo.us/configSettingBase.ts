...
export const _Brand_Name="LeerCapitulo";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Leer 🐠</span><span class="text-orange-600 font-bold"> Capitulo</span>`;
export const _lbl_domain_Page="leercapitulo.us";
export const _lbl_domain_name="leercapitulo.us";
export const _sb_seo_default_image="https://leercapitulo.us/bg.jpg";
...
export const analytics_key='G-DDYKG7FNPQ';
