...
export const _Brand_Name="Solo";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Solo </span><span class="text-orange-600 font-bold">Manga</span>`;
export const _lbl_domain_Page="mangasolo.org";
export const _lbl_domain_name="mangasolo.org";
export const _sb_seo_default_image="https://mangasolo.org/bg_br.jpg";
...
export const analytics_key='G-X5D8MDQJX2';
