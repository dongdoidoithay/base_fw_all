...
export const _Brand_Name="Manga-Iro";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Manga 🐠</span><span class="text-orange-600 font-bold"> Iro</span>`;
export const _lbl_domain_Page="mangairo.xyz";
export const _lbl_domain_name="mangairo.xyz";
export const _sb_seo_default_image="https://mangairo.xyz/bg.jpg";
...
export const analytics_key='G-T5SYG6RT5N';
