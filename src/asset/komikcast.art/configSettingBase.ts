...
export const _Brand_Name="Komik-Cast";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Komik 🐠</span><span class="text-orange-600 font-bold"> Cast</span>`;
export const _lbl_domain_Page="komikcast.art";
export const _lbl_domain_name="komikcast.art";
export const _sb_seo_default_image="https://komikcast.art/bg.jpg";
...
export const analytics_key='G-60SG1ZBTEV';
