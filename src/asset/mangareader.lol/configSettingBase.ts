...
export const _Brand_Name="mangareader";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">Reader</span>`;
export const _sb_seo_default_image="https://mangareader.lol/bg.jpg";
export const _lbl_domain_Page="mangareader.lol";
export const _lbl_domain_name="mangareader.lol";
...
export const analytics_key='G-W2DSQ8NL48';
