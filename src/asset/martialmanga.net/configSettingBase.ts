...
export const _Brand_Name="martial";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">martial </span><span class="text-orange-600 font-bold">Manga</span>`;
export const _lbl_domain_Page="martialmanga.net";
export const _lbl_domain_name="martialmanga.net";
export const _sb_seo_default_image="https://martialmanga.net/bg_br.jpg";

export const _sb_seo_df_title=sample(base_info_name_manga_title(_lbl_domain_name,_Brand_Name)) ;
...
export const _info_name_manga= "Read {name}";
...
export const analytics_key='G-FXH0V2Z14T';
