...
export const _Brand_Name="yesmanga";


export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold"> YES</span>`;
export const _lbl_domain_Page="yesmanga.xyz";
export const _lbl_domain_name="yesmanga.xyz";
export const _sb_seo_default_image="https://yesmanga.xyz/bg.jpg";
...
export const analytics_key='G-9MMTEBH2EL';
