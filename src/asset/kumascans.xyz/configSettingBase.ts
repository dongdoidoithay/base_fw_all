...
export const _Brand_Name="Kuma Scans";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Kuma</span>💚<span class="text-orange-600 font-bold">Scan</span>`;
export const _lbl_domain_Page="kumascans.xyz";
export const _lbl_domain_name="kumascans.xyz";
export const _sb_seo_default_image="https://kumascans.xyz/bg.jpg";
...
export const analytics_key='G-NK1SGP1M0T';
