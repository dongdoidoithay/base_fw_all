...
export const _Brand_Name="Kir-Yuu";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Kir 🐠</span><span class="text-orange-600 font-bold"> Yuu</span>`;
export const _lbl_domain_Page="kiryuu.xyz";
export const _lbl_domain_name="kiryuu.xyz";
export const _sb_seo_default_image="https://kiryuu.xyz/bg.jpg";
...
export const analytics_key='G-TW2SXJY2BD';
