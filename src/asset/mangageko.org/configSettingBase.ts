...
export const _Brand_Name="Manga-Ko";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Manga 🐠</span><span class="text-orange-600 font-bold"> Ko</span>`;
export const _lbl_domain_Page="mangageko.org";
export const _lbl_domain_name="mangageko.org";
export const _sb_seo_default_image="https://mangageko.org/bg.jpg";
...
export const analytics_key='G-7EEFDX8W3P';
