...
export const _lbl_domain_Page="yesmangas.xyz";
export const _lbl_domain_name="yesmangas.xyz";
export const _sb_seo_default_image="https://yesmangas.xyz/bg.jpg";
...
export const analytics_key='G-WJ3XG9ZQF6';
