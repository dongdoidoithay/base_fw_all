...
export const _Brand_Name="Hasu";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Hasu </span><span class="text-orange-600 font-bold">Baca</span>`;
export const _lbl_domain_Page="mangahasu.org";
export const _lbl_domain_name="mangahasu.org";
export const _sb_seo_default_image="https://mangahasu.org/bg_br.jpg";
...
export const analytics_key='G-PGVKN6XYFB';
