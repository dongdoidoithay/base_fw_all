...
export const _Brand_Name="kirYuu";

export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Kir 🐠</span><span class="text-orange-600 font-bold"> Yuu</span>`;
export const _lbl_domain_Page="kiryuu.us";
export const _lbl_domain_name="kiryuu.us";
export const _sb_seo_default_image="https://kiryuu.us/bg.jpg";
...
export const analytics_key='G-VVP1BCJWTM';
